    ...
    <div class="alldata ">
	    <div class="container">
	    	...
	    	<div class="section center-align">	
	    		...
	    		<h5 class="orange-text darken-3"><strong>Basic Subtraction </strong>: Lets define basic rules of subtraction .</h5>
	    	</div>
	    	...
	    	<div class=" z-depth-2 white">
	    		...
	    		<nav>
				    <div class="nav-wrapper">
				      <a href="#" class=" center">Basics of Subtraction</a>
				      <ul id="nav-mobile" class="right">
				      	<li><a href="subgamepage.php" class=" waves-light waves-effect">
	    		...
	    		<div class="contentofsub">
	    			<br><br>
	    			<h4 class="blue-text">Basics of Subtraction</h4>

	    			<br><br>

	    			<img src="images/subbasic.png " class="responsive-img">
	    			...
	    			<div class="examples">
		    			<h5>Some Examples:</h5>
		    			<br>
		    			<img src="images/sub1.jpg " class="responsive-img">
		    			<br><br><br><br>
		    			<img src="images/sub2.jpg " class="responsive-img">
		    			<br><br><br><br>
		    			<img src="images/sub3.jpg " class="responsive-img">
		    			<br><br><br><br>
		    			<img src="images/sub4.jpg " class="responsive-img">
		    			<br><br>
	    			</div>
	    			<br>
	    			<div class="video">
		    			...
		    			<video class="responsive-video" controls>
					   		 <source src="videos/sub.mp4" type="video/mp4">
					 	</video>
					</div> 
					<br><br>
					<a href="subgamepage.php"><button class="btn waves-effect waves-light orange btn-large"  >Continue to Subtraction Test</button></a>	
