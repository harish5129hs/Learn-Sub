    ...
    <div class="alldata ">
	    <div class="container">
	    	...
	    	<div class="section center-align">	
	    		...
	    		<h5 class="orange-text darken-3"><strong>Basics of Find Greater </strong>: Lets learn about  numbers .</h5>
	    	</div>
	    	...
	    	<div class=" z-depth-2 white">
	    		...
	    		<nav>
				    <div class="nav-wrapper">
				      <a href="#" class=" center">Find Greater</a>
				      <ul id="nav-mobile" class="right">
				      	<li><a href="greaterpage.php" class=" waves-light waves-effect">
				      		 Continue To Greater Test 	</a></li>
	    		...
	    		<div class="contentofsub">
	    			<br><br>
	    			<h4 class="blue-text">Basics of Find Greater </h4>

	    			<br><br>
	    			<h5 class="orange-text text-darken-4">Lets learn which number is bigger than other.<br><br>
	    			...
	    			<div class="video">
		    			...
		    			<video class="responsive-video" controls>
					   		 <source src="videos/compare.mp4" type="video/mp4">
					 	</video>
					</div> 
					<br><br>
					<a href="greaterpage.php"><button class="btn waves-effect waves-light orange btn-large"  >Continue to Greater Test</button></a>	
