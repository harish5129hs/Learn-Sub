    ...
    <div class="alldata ">
	    <div class="container">
	    	...
	    	<div class="section center-align">	
	    		...
	    		<h5 class="orange-text darken-3"><strong>Two digit  Subtraction </strong>: Lets define basic rules of borrowing in subtraction .</h5>
	    	</div>
	    	...
	    	<div class=" z-depth-2 white">
	    		...
	    		<nav>
				    <div class="nav-wrapper">
				      <a href="#" class=" center">Basics of 2 digit Subtraction</a>
				      <ul id="nav-mobile" class="right">
				      	<li><a href="twodigitsubgamepage.php" class=" waves-light waves-effect">
				      		 Continue To Subtraction Test 	</a></li>
	    		...
	    		<div class="contentofsub">
	    			<br><br>
	    			<h4 class="blue-text">Basics of 2 digit Subtraction</h4>

	    			<br><br>
	    			<img src="images/2digit01.png " class="responsive-img">
		    			<br><br>
		    			<img src="images/2digit02.png " class="responsive-img">
		    			<br><br>
		    			<img src="images/2digit03.png" class="responsive-img">
		    			<br><br><br><br>
	    			<h4 class="blue-text text-darken-4">Basics of 2 digit Subtraction with borrowing</h4>
	    			<br><br>
	    			<img src="images/2digit1.png " class="responsive-img">

	    			

	    			
		    			
		    			<img src="images/2digit2.png " class="responsive-img">
		    			<br><br>
		    			<img src="images/2digit3.png " class="responsive-img">
		    			<br><br>
		    			<img src="images/2digit4.png" class="responsive-img">
		    			<br><br>
		    			<img src="images/2digit5.png " class="responsive-img">
		    			<br><br>
	    			...
	    			<div class="video">
		    			...
		    			<video class="responsive-video" controls>
					   		 <source src="videos/sub4.mp4" type="video/mp4">
					 	</video>
					</div> 
					<br><br>
					<a href="twodigitsubgamepage.php"><button class="btn waves-effect waves-light orange btn-large"  >Continue to Subtraction Test</button></a>	
