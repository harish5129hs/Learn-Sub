...
<head>
	...
	<script type="text/javascript">
		...
		var total=0 , correct =0 , incorrect=0,random;
		...
		function start(){
			...
			var imghtml='<img src="images/Buttefly1.gif" class="pointer-cursor hvr-buzz" width="70%" height="70px">';
		...
		function check(){
			...
			if(number!=''){
				if(number==random){
					...
					$('#youranswer').html(number);
					$('.mymsg').html(msg1);
					$('#correctanswer').html(random);
					var imgid = "images/no"+random+".png";
					var imgsrc = "<img src='"+imgid+"' height='110px'>";
					$('#correctimage').html(imgsrc);
		...
		function gameends(){
			...
			if(correct>=5){
				...
				$.post("complete.php",{type:'count'},function(result){
					console.log(result);
...
<body class="grey lighten-5">
    ...
    <div class="alldata ">
	    <div class="container">
	    	...
	    	<div class="section center-align">	
	    		...
	    		<h5 class="orange-text darken-3"><strong>Count It </strong>: Lets test your counting skills and knowledge of numbers.</h5>
	    	</div>
	    	...
	    	<div class=" z-depth-2 white">
	    		...
	    		<nav>
				    <div class="nav-wrapper">
				      <a href="#" class=" center">Count the Butteflies</a>
	    				...
	    				<div id="game" class="margin2p">
	    					...
	    					<br>
	    						<div class="contentofstart ">
	    							<h4 class="blue-text">Count the butterflies</h4>
	    							<br>
	    							<ul>
	    								<li>This is a test to check your Knowledge of numbers.</li>
	    							
	    							<li>There will be butterflies shown on screen and you have to count them.</li>
	    							
	    							<li>There will be 8 tries and to pass you have to get 5 correct.</li>
	    							</ul>
	    						</div>
	    						<br>
	    						<br>
	    					...
	    					<div id="maingame">
		    					...
		    					<div id="pics" class=" ">
			    					<div class="row">
			    						...
			    						<div class="col s12 m2" id="co5"></div>
			    						<div class="col s12 m2" id="co1"></div>
			    						<div class="col s12 m2" id="co2"></div>
			    						<div class="col s12 m2" id="co7"></div>
			    						<div class="col s12 m2" id="co9"></div>
			    					</div>	
			    					<div class="row">
			    						<div class="col s12 m2" ></div>
			    						<div class="col s12 m2" id="co6"></div>
			    						<div class="col s12 m2" id="co3"></div>
			    						<div class="col s12 m2" id="co4"></div>
			    						<div class="col s12 m2" id="co8"></div>
			    						<div class="col s12 m2" ></div>
		    					...
		    					<div class="inputbox">
		    						<div class="row">
				    					...
				    					<div class="input-field left-align">
								          ...
								          <label for="signinpass" class="active">Enter the number of butteflies</label>
								        </div>
								        </div>
								        <div class="col m4 s12 left-align">
								        <br>
								        <button class="btn blue lighten-2 waves-light waves-effect hvr-bounce-in" onclick="check();">Submit</button>
								        </div>
								    </div>
							     </div>   
  ...
  <div id="help" class="modal ">
	    <div class="modal-content">
	      ...
	      <p>Count the number of butterflies .<br>
	      	Enter the value in input field and press send button.
	      </p>
	    </div>
  ...
  <div id="incorrect" class="modal smallmodal center-align">
	    <div class="modal-content">
	      ...
	      <br>
	      <h6 class="blue-text">Let's check where you did wrong</h6>
	    	<div class="row">
		      <div class=" col s6 whatwrong center-align">
		      		<br>
		      		<br>
			      <h5 class="red-text">Your answer : <span id="youranswer"> </span></h5>
			      
			      <h5 class="green-text">Correct answer : <span id="correctanswer"> </span></h5>
			   </div>
				<div class="col s6">   
			      <p class="yellow-text text-darken-3">Remember for next time!!</p>

			      <div id="correctimage"></div>
		      	</div>
	      	</div>
	      	<br>
	    ...
	    <div class="modal-footer">
	      ...
	      <div class="left-align" style="float: left;">
	      	<a href="basiccountpage.php" class="waves-effect waves-green btn-flat left-align">Revisit tutorial</a>	
	      </div>	
